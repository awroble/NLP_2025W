...
from services.state import init_statements_state, get_current_index, get_statements, insert_new_statement_after_current
...
"""
    ...
    init_statements_state(json_data, json_file_path)
    ...
    full_stmt = current_statement.get("full_statement", "")

    left_col, right_col = st.columns([3, 2])

    with left_col:
        highlighted_context = highlight_in_context(raw_context, full_stmt)
